...
import torch
import pickle
from auctionbid.strategy.base_bidding_strategy import BaseBiddingStrategy
import os
import random
# from auctionbid.baseline.iql.iql import IQL
...
class CqlBiddingStrategy(BaseBiddingStrategy):
    ...
    def __init__(self, budget=100, name="Cql-PlayerStrategy", cpa=2, category=1):
        ...
        model_path = os.path.join("log", "CQLtest", "cql_model.pth")
        dict_path = os.path.join("log", "CQLtest", "normalize_dict.pkl")
    ...
    def bidding(self, timeStepIndex, pValues, pValueSigmas, historyPValueInfo, historyBid,
        ...
        #     alpha = self.model(random_test_state,eval_flag=True)
        #     print("----------random: ", alpha)
