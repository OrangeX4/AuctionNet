...
class BC(nn.Module):
    """
        Usage:
        bc = BC(dim_obs=16)
        bc.load_net(load_path="path_to_log")
    ...
    def load_net(self, load_path="log/fixed_initial_budget", device='cpu'):
    ...
    def load_net_pkl(self, load_path="log/fixed_initial_budget"):
